...
export default function CustomPresetPanel({ config, onChange }: Props) {
  ...
  return (
    <div className="border border-primary p-4 mt-4 bg-panel">
      <h3 className="uppercase font-bold mb-4 border-b border-primary pb-2">Custom Preset Configuration</h3>
        ...
        {AVAILABLE_STEPS.map(step => {
          ...
          return (
            <TerminalButton
              ...
              className={`text-xs ${isActive ? 'bg-primary text-bg-base font-bold' : 'opacity-70'}`}
            >
              {step}
            </TerminalButton>
          );
        ...
        <div className="mt-6 border-t border-primary/30 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {config.Steps.map(step => (
              <div key={step.Name} className="border border-primary/50 p-3 bg-bg-base/50">
                <h5 className="font-bold text-primary mb-2">{step.Name}</h5>
